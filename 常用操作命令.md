...
* 再来一个，将这个全部拷贝过去，如图![cp -r](https://github.com/mimizao/Linux/blob/master/images/cp%20-r命令.png)，这里的-r是递归的意思，将dd目录下的xxx也一块拷贝过去；来一个扩展，这里可以看到，新出来的xxx其实就是dd变成了这个![cp -r](https://github.com/mimizao/Linux/blob/master/images/cp%20-r命令.png)
